...
variable "github_codestar_connection_arn" {
  type        = string
  description = "AWS GitHub Codestar Connection ARN"
}

variable "detect_change_source" {
  type        = bool
  default     = true
  description = "Whether to detect changes in the source code and run pipeline automatically"
}
...
variable "manual_approval" {
  type        = bool
  default     = true
  description = "Add Manual Approval stage to CodePipeline"
}